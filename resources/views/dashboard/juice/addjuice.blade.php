  ...
  <div class="card">
    <div class="card-header">
      ...
      <div class="card-body">
        ...
        @endif
        <form action="{{('storejuice')}}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
          <h6 class="heading-small text-muted mb-4">juice information</h6>
          <div class="pl-lg-4">
            ...
            <div class="col-lg-9">
              <div class="form-group">
                ...
                <input rows="4" class="form-control" name="price" placeholder="you can add price of item">
              </div>
            </div>
            ...
            <div class="col-lg-9">
              <div class="form-group">
                ...
                <input rows="4" class="form-control" name="status" placeholder="you can add price of item">
              </div>
            </div>
